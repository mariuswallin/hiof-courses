// /app/components/questions/pages/QuestionDetail.tsx
"use client";
...
import { deleteQuestionAction } from "@/app/api/questions/questionsServerActions";
...
export function QuestionDetail({ id }: QuestionDetailProps) {
  ...
  const handleRemoveQuestion = async () => {
    ...
    // Error handling is left out here to keep the flow readable.
  ...
  return (
    <div className="p-8 sm:p-4 max-w-4xl mx-auto container">
