# l-09 — Lister med FlatList

Branch for leksjon 09 i `react-native`.

Effektiv visning av lister med React Natives FlatList komponent.

## Læringsmål

Se leksjonen i [`data/courses/react-native/lessons/09-*.mdx`](../../../data/courses/react-native/lessons/) for fullstendige læringsmål og oppgaver.
