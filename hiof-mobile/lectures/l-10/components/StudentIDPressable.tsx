...
export default function StudentID({
  ...
  return (
    <Pressable
      // Calls handleStudentPress when the card is tapped
      onPress={handleStudentPress}
      // Dynamic style driven by press state. The pressed parameter tells us whether
      // the component is being pressed right now.
      style={({ pressed }) => [
        styles.container,
        // Different style when the student is inactive
        !isActive && styles.inactiveContainer,
        // Change the look when the card is pressed
