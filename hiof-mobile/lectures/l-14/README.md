# l-14 — Route grupper og Tabs

Branch for leksjon 14 i `react-native`.

Implementere tab-navigasjon for flerskjerms applikasjoner.

## Læringsmål

Se leksjonen i [`data/courses/react-native/lessons/14-*.mdx`](../../../data/courses/react-native/lessons/) for fullstendige læringsmål og oppgaver.
