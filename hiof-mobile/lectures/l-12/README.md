# l-12 — Stack navigasjon

Branch for leksjon 12 i `react-native`.

Avansert navigasjon med stack-basert arkitektur.

## Læringsmål

Se leksjonen i [`data/courses/react-native/lessons/12-*.mdx`](../../../data/courses/react-native/lessons/) for fullstendige læringsmål og oppgaver.
