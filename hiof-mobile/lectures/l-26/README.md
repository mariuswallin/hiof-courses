# l-26 — API-integrasjon med TanStack Query (queries og listing)

Branch for leksjon 26 i `react-native`.

Bruk TanStack Query for caching, henting og synkronisering av data. Fokuser på useQuery og listing av studenter.

## Læringsmål

Se leksjonen i [`data/courses/react-native/lessons/26-*.mdx`](../../../data/courses/react-native/lessons/) for fullstendige læringsmål og oppgaver.
