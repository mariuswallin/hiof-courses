# l-16 — Forms del 1 - grunnleggende

Branch for leksjon 16 i `react-native`.

Bygge og håndtere formularer i React Native.

## Læringsmål

Se leksjonen i [`data/courses/react-native/lessons/16-*.mdx`](../../../data/courses/react-native/lessons/) for fullstendige læringsmål og oppgaver.
